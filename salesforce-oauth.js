    ...
    oauth2.authenticate({
        ...
        if (token) {
            ...
            */
            callAllPromise().then(result => {
                console.log(chalk.bgGreen('to front-end'));
                let myJSON = JSON.stringify(istart, null, '  ');
                let obj = JSON.parse(myJSON);
                let keys = Object.keys(obj);
                ...
                for (let i = 0; i < keys.length; i++) {
                    ...
                    for (let j = 0; j < innerKeys.length; j++) {//innerKeys.length
                        ...
                        for (let k = 0; k < inner2Keys.length; k++) {
                            ...
                            for (let l = 0; l < inner3Keys.length; l++) {
                                console.log(chalk.bgCyan("[", j," ",k, ",", l, ']: '), inner3Keys[l], " object: ", inner3Obj[inner3Keys[l]]);
                            }
                        }
                    }
                }
                ...
                .then(result => {
                    ...
                    return list(urlReports, options)
                        .then(result => {
                            ...
                            return list(urlPreselection, options)
                                .then(result => {
                                    istart = result;
